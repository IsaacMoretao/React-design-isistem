  ...
  return (
    <div className="w-scrieen h-screen bg-gray-900 flex flex-col items-center justify-center">
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        <Text asChild>
          <a href="" className="text-gray-400 underline hover:text-gray-200">Equeceu sua senha?</a>
        </Text>
        <Text asChild>
          <a href="" className="text-gray-400 underline hover:text-gray-200 cursor-pointer">Não possue uma conta? crie uma agora</a>
        </Text>
